...
import (
	...
	config "github.com/veska-io/streams-connectors/binance/futures/open-interest/events-generator/src/config"
	local_consumer "github.com/veska-io/streams-connectors/binance/futures/open-interest/events-generator/src/consumer"
	logger "github.com/veska-io/streams-connectors/binance/futures/open-interest/events-generator/src/logger"
)
...
func TestConsumer(t *testing.T) {
	...
	for row := range c.DataStream {
		kline := local_consumer.OpenInterest{}

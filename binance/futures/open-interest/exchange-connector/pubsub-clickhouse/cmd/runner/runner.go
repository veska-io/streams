...
import (
	...
	pubsub_clickhouse "github.com/veska-io/streams-connectors/binance/futures/open-interest/exchange-connector/pubsub-clickhouse/src"
	"github.com/veska-io/streams-connectors/binance/futures/open-interest/exchange-connector/pubsub-clickhouse/src/config"
	"github.com/veska-io/streams-connectors/binance/futures/open-interest/exchange-connector/pubsub-clickhouse/src/logger"
)
...
func MustRun(ctxGcp context.Context) {
	...
	connector, err := pubsub_clickhouse.New(ctx, logger, cancel,

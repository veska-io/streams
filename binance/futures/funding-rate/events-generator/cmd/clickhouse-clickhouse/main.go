...
import (
	...
	"github.com/veska-io/streams-connectors/binance/futures/funding-rate/events-generator/src/config"
	"github.com/veska-io/streams-connectors/binance/futures/funding-rate/events-generator/src/connector"
	"github.com/veska-io/streams-connectors/binance/futures/funding-rate/events-generator/src/logger"
	producer "github.com/veska-io/streams-connectors/binance/futures/funding-rate/events-generator/src/producers/clickhouse"
)
...
func main() {
	...
	p, err := producer.New(ctx, logger,
		...
		cfg.ClickhouseProducer.Table, time.Duration(cfg.ClickhouseProducer.WriteIntervalSeconds)*time.Second,
	)
	if err != nil {

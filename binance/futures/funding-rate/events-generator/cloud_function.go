...
import (
	...
	producer "github.com/veska-io/streams-connectors/binance/futures/funding-rate/events-generator/src/producers/pubsub"
)
...
func RunConnector(ctx context.Context, e event.Event) error {
	...
	connector, err := connector.New(ctx, logger, "binance-klines-events-generator", "v0.0.1",
